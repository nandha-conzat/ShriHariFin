 ...
 */
public class InvestTopTen extends AppCompatActivity {

    private ListView listView;
    private String Top10InvestURL = ShriHariConstants.GET_TOP_TEN_INVESTMENT;
    private String jsonResult;
    Context context = InvestTopTen.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.invest_top_ten);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(InvestTopTen.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{Top10InvestURL});
    }
