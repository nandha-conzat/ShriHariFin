 ...
 */
public class SpentFullList extends AppCompatActivity {

    private ListView listView;
    private String SpentFullListURL = ShriHariConstants.GET_SPENT_URL;
    private String jsonResult;
    Context context = SpentFullList.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spent_full_list);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(SpentFullList.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{SpentFullListURL});
