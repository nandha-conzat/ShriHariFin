 ...
 */
public class InvestYear extends AppCompatActivity {

    private ListView listView;
    private String YearInvestURL = ShriHariConstants.GET_YEAR_INVESTMENT;
    private String jsonResult;
    Context context = InvestYear.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.invest_year);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(InvestYear.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{YearInvestURL});
    }
