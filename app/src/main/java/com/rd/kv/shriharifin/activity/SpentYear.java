 ...
 */
public class SpentYear extends AppCompatActivity {

    private ListView listView;
    private String YearSpentURL = ShriHariConstants.GET_YEAR_SPENT;
    private String jsonResult;
    Context context = SpentYear.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spent_year);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(SpentYear.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{YearSpentURL});
