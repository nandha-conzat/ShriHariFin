 ...
 */
public class SpentTopTen extends AppCompatActivity {

    private ListView listView;
    private String Top10SpentURL = ShriHariConstants.GET_TOP_TEN_SPENT;
    private String jsonResult;
    Context context = SpentTopTen.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spent_top_ten);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(SpentTopTen.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{Top10SpentURL});
