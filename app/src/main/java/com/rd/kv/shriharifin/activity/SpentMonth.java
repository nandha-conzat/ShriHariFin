 ...
 */
public class SpentMonth extends AppCompatActivity {

    private ListView listView;
    private String MonthSpentURL = ShriHariConstants.GET_MONTH_SPENT;
    private String jsonResult;
    Context context = SpentMonth.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spent_month);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(SpentMonth.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{MonthSpentURL});
