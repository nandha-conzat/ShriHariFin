 ...
 */
public class InvestToday extends AppCompatActivity {

    private ListView listView;
    private String TodayInvestURL = ShriHariConstants.GET_TODAY_INVESTMENT;
    private String jsonResult;
    Context context = InvestToday.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.invest_today);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(InvestToday.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{TodayInvestURL});
