...
import com.rd.kv.shriharifin.helper.ProgressDialogHelper;
 ...
 */
public class InvestFullList extends AppCompatActivity {

    private ListView listView;
    private String InvestFullListURL = ShriHariConstants.GET_INVESTERS_URL;
    private String jsonResult;
    Context context = InvestFullList.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.invest_full_list);
    ...
    public void accessWebService() {
        ...
        loading = ProgressDialog.show(InvestFullList.this, "Loading ", "Please wait...", true, true);
        task.execute(new String[]{InvestFullListURL});
    }
